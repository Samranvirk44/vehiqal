...
export const metadata: Metadata = {
  title: 'Sell Your Car in Islamabad — Free on Vehiqal',
  description: 'Sell your car in Islamabad safely. Free listing, verified buyers, payment guaranteed. Call 0311 4642679.',
}
