      ...
      <div className="max-w-7xl mx-auto px-4 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 mb-5">
            ...
            <a href="tel:+923034642619" className="flex items-center gap-2 text-gold font-black text-lg mt-2 hover:text-yellow-300 transition-colors">
              📞 0303 4642619
            </a>
        ...
        <div>
          ...
          <div className="mt-6 bg-white/5 border border-white/10 rounded-xl p-4">
            ...
            <a href="tel:+923034642619" className="text-gold font-black text-xl hover:text-yellow-300 transition-colors">0303 4642619</a>
          </div>
        </div>
      </div>
